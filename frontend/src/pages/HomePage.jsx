...
const HomePage = () => {
  ...
  return (
    <>
      <div className="flex flex-col md:flex-row items-center px-6 md:px-20 py-12 md:py-20 min-h-[calc(100vh-80px)] bg-base-100">
        {/* Left Content */}
        <div className="flex-1 pr-0 md:pr-16 text-center md:text-left mb-10 md:mb-0">
          ...
          <p className="text-base-content/70 text-lg leading-relaxed mb-8 max-w-lg mx-auto md:mx-0">
            Explore thousands of restaurants and dishes, right at your
            fingertips.
          </p>
